...
| **ANALYST** | analyst  | analyst123 | Can view records and summaries (own data only). Cannot create/edit records. |
...
1. **Data Visibility Isolation**: I made a strict architectural assumption that **Admins have global visibility** over all records in the system, whereas **Analysts and Viewers can only view their own specific records and their own dashboard summary**. This ensures no data-leaking between standard users.
